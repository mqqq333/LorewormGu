...
def init_model(lm_config):
    tokenizer = AutoTokenizer.from_pretrained('/home/u3210104896/LorewormGu')
    model = LorewormGu(lm_config)
...
if __name__ == "__main__":
     ...
     parser.add_argument("--wandb_project", type=str, default="LorewormGu-SFT")
     ...
     args.wandb_run_name = f"LorewormGu-Distill-Epoch-{args.epochs}-BatchSize-{args.batch_size}-LearningRate-{args.learning_rate}"
